    ...
    def __init__(self, scope: Construct, id: builtins.str, rfl_stack: IRflStack, apigateway: FaceLivenessGateway, cognito: FaceLivenessCognito) -> None:
        ...
        self.amplify = amplify2.App(self, "Rfl-Web-App",
            ...
            source_code_provider=amplify2.GitHubSourceCodeProvider(
                owner="KIRITHICK-KANNAN",
                repository="AWS-Liveness",
                oauth_token=SecretValue.secrets_manager("github-token")
            )
        )

        self.amplify.add_environment("REACT_APP_ENV_API_URL", apigateway.rest_api_url())
        self.amplify.add_environment("REACT_APP_IDENTITYPOOL_ID", cognito.idp.ref)
        self.amplify.add_environment("REACT_APP_USERPOOL_ID", cognito.cognito.user_pool_id)
        self.amplify.add_environment("REACT_APP_WEBCLIENT_ID", cognito.client.user_pool_client_id)
        self.amplify.add_environment("REACT_APP_REGION", core.Stack.of(self).region)

        self.amplify.add_branch("main", auto_build=True)
...
class TriggerFrontEndBuild(Construct):
    ...
    def __init__(self, scope: Construct, id: builtins.str, rfl_stack: IRflStack, amplifyApp: FaceLivenessFrontEnd) -> None:
        ...
        # No need for manual startJob call if Amplify is connected to GitHub and auto-build is enabled.
        pass
...
class FaceLivenessFrontEndBuildStatus(Construct):
    ...
    def __init__(self, scope: Construct, id: builtins.str, rfl_stack: IRflStack, amplifyApp: FaceLivenessFrontEnd, buildTrigger: TriggerFrontEndBuild) -> None:
        ...
        self.lambda_function = lambda_.Function(self, 'Rfl-Web-App-Lambda',
            function_name=f'{rfl_stack.stack_name}-webapp-deployment',
        ...
        input_payload = f'{{"app":"{rfl_stack.stack_name}","branch":"main"}}'
        ...
        self.appStatus = cr.AwsCustomResource(self, id="Rfl-Web-App-Deploy-Status",
            ...
            on_create=cr.AwsSdkCall(
                service='Lambda',
                action='invoke',
                physical_resource_id=cr.PhysicalResourceId.of(f'{rfl_stack.stack_name}-webapp-stack'),
                parameters={
                    'FunctionName': self.lambda_function.function_name,
                    "InvocationType": "RequestResponse",
        ...
        CfnOutput(self, id="RFL-Web-App-URL",
                  value=f"https://main.{amplifyApp.amplify.app_id}.amplifyapp.com",
                  export_name="RFL-Web-App-URL")
